...
namespace InventarioSuper.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (!await _roleManager.RoleExistsAsync(Roles.Administrador))
                    {
                        ...
                        await _roleManager.CreateAsync(new IdentityRole(Roles.Colaborador));
                    }

                    string rol = Request.Form["RolUsuario"].ToString();
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, Roles.Colaborador);
                    }
